...
namespace lantern {
    ...
    namespace cnn {
        ...
        namespace optimizer {
            ...
            public:
                af::array w_mt, w_vt;
                lantern::utility::Vector<af::array> w_vector_velocity;
                lantern::utility::Vector<af::array> w_stack_previous_gradient;
                lantern::utility::Vector<af::array> b_vector_velocity;
                lantern::utility::Vector<af::array> b_stack_previous_gradient;
